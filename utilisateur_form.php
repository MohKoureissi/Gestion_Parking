...
if (isset($_POST['enregistrer'])) {
    if (isset($_POST['nom'], $_POST['role'], $_POST['password']));
    $req = $bd->prepare('insert into utilisateur(nom,role,password) values(?,?,?)');
    $req->bindValue(1, $_POST['nom']);
    $req->bindValue(2, $_POST['role']);
...
if (isset($_POST['modifier'])) {
    if (isset($_POST['nom'], $_POST['role'], $_POST['password']));
    $req = $bd->prepare('update utilisateur set nom=?, role=?, password=? where id=?');
    $req->bindValue(1, $_POST['nom']);
    $req->bindValue(2, $_POST['role']);
    $req->bindValue(3, $_POST['password']);
    ...
    <fieldset>
        ...
        <form action="utilisateur_form.php" method="post">
            ...
            <div>
                ...
                <input type=" text" name="role" value="<?php if (isset($_POST['role'])) echo $_POST['role'] ?>">
            </div>
            <div>
